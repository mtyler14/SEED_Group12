...
sys_speed = sys*2; % scale to 1 rad/s for each motor
...
sys_speed2 = sys2*2; % scale to 1 rad/s for each motor
...
sys_speed_pos = tf((K*2*sigma),[1 sigma 0]); % add integrator
...
sys_speed_pos2 = tf((K1*2*sigma1),[1 sigma1 0]); % add integrator
